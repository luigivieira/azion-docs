...
- [Function Arguments and Environment Variables](../development/function-arguments-and-environment-variables.md) — how to use `event.args` for secrets and configuration.
